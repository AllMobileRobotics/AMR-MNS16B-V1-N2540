...
//  Use INPUT_PULLUP so the line is read as LOW (0)
// ============================================================

// ---- Pin mapping (S1 = leftmost, S8 = rightmost) ----------
const uint8_t PIN_S1 = 13;
const uint8_t PIN_S2 = 12;
const uint8_t PIN_S3 = 14;
const uint8_t PIN_S4 = 27;
const uint8_t PIN_S5 = 26;
const uint8_t PIN_S6 = 25;
const uint8_t PIN_S7 = 33;
const uint8_t PIN_S8 = 32;
